...
meta =
{
    ...
    name = "dark_balance_fix",

    -- Title of your mod that will be displayed to players
    title = "Darkwind's weapon rebalancer",

    -- Type of your mod, either "mod" or "factionpack"
    type = "mod",

    -- Description of your mod that will be displayed to players
    description = "Nerf fighter's health 5 times. And remove seeker from rocket launchets as too much overpowered",
    ...
    contact = "dark.dreamflyer@gmail.com",
}
